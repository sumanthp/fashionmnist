...
function getModel() {
    ...
    model.compile({optimizer:tf.train.adam(0.05),loss:'categoricalCrossentropy', metrics:['accuracy']})// YOUR CODE HERE);
...
async function train(model, data) {
    ...
    const container = {name:'ModelTraining',styles:{ height:'640px'}};// YOUR CODE HERE   
